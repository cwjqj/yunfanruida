...
============================================================
  ...
  Count rule:
  - 0x86/0x0C accurate count is the default people_count source.
  - 0x86/0x0A realtime count is preview/pending evidence only.
  - 0x86/0x14 door events never increment/decrement people_count directly.
  - Confirmed internal tracks remain available as a diagnostic and rollback source.
...
function
	...
	local nid=1
	local pver,fver="Radar_Top_Count_1.1","FW_1.0.0"
	...
	local Count={
		cfg={
			source="accurate", -- "accurate" or "track"
