...
| 文件 | `pver` | SHA256 | 说明 |
|---|---|---|---|
| `versions/count/radar_iot_task_v1.2.lua` | `Radar_Top_Count_1.2` | `A25EC96038C090A3A86093D0029D88CA793C02F6122275CF8B67ED5B32B3F700` | 历史回退版；已完成现场测试 |
...
Count 1.2 已完成“范围内单人、探测边缘同侧三人干扰”现场复核，验证记录见 `顶装/测试记录/2026-07-14_单人边缘干扰复核.md`。
